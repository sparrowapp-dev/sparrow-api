import type { KeyValue } from "../enum/http-request-base.enum";
import { CollectionRequestAddToBaseEnum, type CollectionAuthBaseInterface, type CollectionAuthTypeBaseEnum } from "../enum/collection.request.enum";
import { HttpRequestAuthTypeBaseEnum } from "../enum/http-request-base.enum";
